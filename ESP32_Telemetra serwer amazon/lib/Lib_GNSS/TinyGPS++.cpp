...
uint16_t TinyGPSDate::month()
{
   updated = false;
   return (date / 100) % 100;
}

uint16_t TinyGPSDate::day()
{
   updated = false;
   return date / 10000;
}

uint16_t TinyGPSTime::hour()
{
   updated = false;
   return time / 1000000;
}

uint16_t TinyGPSTime::minute()
{
   updated = false;
   return (time / 10000) % 100;
}

uint16_t TinyGPSTime::second()
{
   updated = false;
   return (time / 100) % 100;
}

uint16_t TinyGPSTime::centisecond()
{
   updated = false;
   return time % 100;
}
